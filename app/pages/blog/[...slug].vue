<template>
  <article
    class="max-w-none prose dark:prose-invert prose-pre:bg-white dark:prose-pre:bg-gray-700 prose-pre:text-gray-700 dark:prose-pre:text-gray-300"
  >
    <ContentDoc>
      <template #not-found>
      ...
      <template v-slot="{ doc }">
        <div class="grid grid-cols-6 gap-16">
          ...
          <div class="col-span-2 not-prose" v-if="doc.toc">
            <aside class="sticky top-8 border-l-4 px-4">
